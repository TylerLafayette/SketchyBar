...
void bar_manager_remove_item(struct bar_manager *bar_manager,
                             struct bar_item *bar_item);
void bar_manager_move_item(struct bar_manager *bar_manager,
                           struct bar_item *item, struct bar_item *reference,
                           bool before);
...
void bar_manager_update_space_components(struct bar_manager *bar_manager,
                                         bool forced);
...
bool bar_manager_set_background_blur(struct bar_manager *bar_manager,
                                     uint32_t radius);
...
bool bar_manager_set_spaces_for_all_displays(struct bar_manager *bar_manager,
                                             bool value);
bool bar_manager_set_displays(struct bar_manager *bar_manager,
                              uint32_t displays);
bool bar_manager_set_hidden(struct bar_manager *bar_manager, uint32_t sid,
                            bool hidden);
bool bar_manager_set_topmost(struct bar_manager *bar_manager, char level,
                             bool topmost);
...
bool bar_manager_set_font_smoothing(struct bar_manager *bar_manager,
                                    bool smoothing);
bool bar_manager_set_notch_width(struct bar_manager *bar_manager,
                                 uint32_t width);
bool bar_manager_set_notch_offset(struct bar_manager *bar_manager,
                                  uint32_t offset);
void bar_manager_sort(struct bar_manager *bar_manager,
                      struct bar_item **ordering, uint32_t count);

struct bar_item *bar_manager_get_item_by_point(struct bar_manager *bar_manager,
                                               CGPoint point,
                                               struct window **window_out);
...
struct bar *bar_manager_get_bar_by_wid(struct bar_manager *bar_manager,
                                       uint32_t wid);
int bar_manager_get_item_index_for_name(struct bar_manager *bar_manager,
                                        char *name);
uint32_t bar_manager_length_for_bar_side(struct bar_manager *bar_manager,
                                         struct bar *bar, char side);
...
void bar_manager_handle_space_windows_change(struct bar_manager *bar_manager,
                                             char *info);
void bar_manager_custom_events_trigger(struct bar_manager *bar_manager,
                                       char *name, struct env_vars *env_vars);
